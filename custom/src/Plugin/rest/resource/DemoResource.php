...
/**
 * Represents Demo records as resources.
 *
 * @RestResource (
 *   id = "custom_demo",
 *   label = @Translation("Demo"),
 *   uri_paths = {
 *     "canonical" = "/api/custom-demo/{id}",
 *     "create" = "/api/custom-demo"
 *   }
 * )
 *
 * @DCG
 ...
 */
final class DemoResource extends ResourceBase {
  ...
  public function __construct(
    ...
    $this->storage = $keyValueFactory->get('custom_demo');
  }
  ...
  public function post(array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('Created new demo record @id.', ['@id' => $data['id']]);
  ...
  public function patch($id, array $data): ModifiedResourceResponse {
    ...
    $this->logger->notice('The demo record @id has been updated.', ['@id' => $id]);
  ...
  public function delete($id): ModifiedResourceResponse {
    ...
    $this->logger->notice('The demo record @id has been deleted.', ['@id' => $id]);
